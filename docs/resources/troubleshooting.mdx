...
<Steps>
  ...
  <Step title="Open an issue" icon="github">
    ...
    - Node runtime: [github.com/AbhishekPanwarr/Blindference-node](https://github.com/AbhishekPanwarr/Blindference-node/issues)
  </Step>
  <Step title="Join Discord" icon="message-circle">
    [Telegram @abhieren](https://t.me/abhieren) for real-time support
  </Step>
</Steps>
