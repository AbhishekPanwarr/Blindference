  ...
  return (
    <Dialog className="relative z-50" onClose={onClose} open={isOpen}>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="relative w-full max-w-md overflow-hidden rounded-2xl border border-zinc-800 bg-[#0a0a0b] p-6 shadow-2xl">
          <button
          ...
          <Dialog.Description className="mb-6 pl-12 text-sm text-zinc-500">
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                className="w-full resize-none rounded-xl border border-zinc-700 bg-zinc-900 p-3 text-sm text-white shadow-sm outline-none transition-all focus:border-white/30 focus:ring-2 focus:ring-white/10"
          ...
          <div className="mt-6 flex justify-end gap-3 border-t border-zinc-800 pt-4">
            <button
              className="rounded border border-zinc-700 bg-zinc-900 px-4 py-2 text-sm font-bold uppercase tracking-widest text-zinc-400 transition-colors hover:bg-zinc-800"
              onClick={onClose}
              type="button"
            >
              Cancel
            ...
            <button
              className="flex min-w-[140px] items-center justify-center rounded bg-white px-6 py-2 text-sm font-bold uppercase tracking-widest text-black shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all hover:bg-zinc-200 disabled:opacity-50"
