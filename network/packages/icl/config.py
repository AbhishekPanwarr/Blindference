...
class Settings(BaseSettings):
    ...
    RESULT_REGISTRY_ADDRESS: str = "0x0000000000000000000000000000000000000000"
    ...
    # Grace period before a node is considered inactive after its last heartbeat.
    # Set to 300s (5 minutes) so the ICL can restart/redeploy without
    # immediately losing all active nodes.
